...
const generateIDBMock = () => {
    ...
    const FDBObjectStore = jest.genMockFromModule('fake-indexeddb/lib/FDBObjectStore')
    const FDBTransaction = jest.genMockFromModule('fake-indexeddb/lib/FDBTransaction')
