...
var openDB = function openDB(dbName, storeName) {
    return new Promise(function (resolve, reject) {
        try {
            ...
            // should not be triggerred since we never change version.
            // add this just in case...
            req.onblocked = function () {
                return reject(new Error("IDBOpenDBRequest.onblocked"));
            };
        } catch (e) {
            reject(error);
        }
...
var IDBStorage = function () {
    function IDBStorage() {
        var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
            ...
            dbName = _ref$dbName === undefined ? "IDBStorage" : _ref$dbName,
            _ref$storeName = _ref.storeName,
            storeName = _ref$storeName === undefined ? "KeyValueStore" : _ref$storeName;
     ...
     * Create transaction
     *
     * It will first establish a new IDB connection if no connection
     * has been establish yet.
     *
     * Invariants
     * - IDBDatabase.transaction() MUST be called in the same sequential order
     *   as _createTx() calls
     */
    ...
    _createClass(IDBStorage, [{
        ...
        value: function _createTX(mode) {
            ...
            return new Promise(function (resolve, reject) {
                if (_this.db) {
                    try {
                        var tx = _this.db.transaction([_this.storeName], mode);
                        resolve(tx);
                    } catch (e) {
                        ...
                        if (e.name === "InvalidStateError") {
                            _this.close();
                            // will fallthough this 'if' block to re-create a new DB connection
                        } else {
                            reject(e);
                        }
                    }
                ...
                // Defer the transaction promise in a queue
                // and fullfill them after DB connection is established
                _this.deferredTXs.push({ resolve: resolve, reject: reject, mode: mode });

                if (_this.dbOpening) return;

                _this.dbOpening = true;
                openDB(_this.dbName, _this.storeName).then(function (db) {
                    _this.db = db;
                    _this.dbOpening = false;
                    ...
                    try {
                        for (var _iterator = _this.deferredTXs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                            var _ref2 = _step.value;
                            var _resolve = _ref2.resolve;
                            var _reject = _ref2.reject;
                            var _mode = _ref2.mode;
                            ...
                            try {
                                var _tx = _this.db.transaction([_this.storeName], _mode);
                                _resolve(_tx);
                            } catch (e) {
                                txErr = e;
                                _reject(e);
                    ...
                    try {
                        for (var _iterator2 = _this.deferredTXs[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                            var _ref3 = _step2.value;
                            var _reject2 = _ref3.reject;
            ...
            return this._createTX("readwrite").then(function (tx) {
                return new Promise(function (resolve, reject) {
                    try {
                        ...
                        // TODO (review): abort should not be called...but worth testing anyway..
                        tx.onabort = tx.onerror = function () {
                            var e = req.error ? req.error : req.transaction.error;
                            reject(e);
                        };
                    } catch (e) {
                        reject(e);
            ...
            return this._createTX("readwrite").then(function (tx) {
                return new Promise(function (resolve, reject) {
                    try {
                        ...
                        // TODO (review): The request will be also be aborted if we've exceeded our storage space.
                        tx.onabort = function () {
        ...
        value: function keys() {
            ...
            return this._createTX("readonly").then(function (tx) {
                return new Promise(function (resolve, reject) {
                    try {
                        var req = tx.objectStore(_this7.storeName).openCursor();
                        var keys = [];
        ...
        /*
         * iteratee: function(key, value). return 0 to terminate iteration
         * before its completion
         *
         * @return {Promise} fulfilled when iteration is completed; rejected if
         *                   when db issue occured
         */
        ...
        value: function iterate(iteratee) {
            ...
            return this._createTX("readonly").then(function (tx) {
                return new Promise(function (resolve, reject) {
                    try {
                        var req = tx.objectStore(_this8.storeName).openCursor();
 ...
 *   different test.
 */
describe("IDBStorage basic test", function () {
    var dbname = "IDBStorage.test.basic." + Date.now();
    var db = new _index2.default({ dbName: dbname });

    /*
     * TODO: Find out why failing to delete database. might be due to unclosed connection
     */
    afterAll(function (done) {
        db.close();
        var req = window.indexedDB.deleteDatabase(dbname);
        req.onerror = req.onblocked = req.onupgradeneeded = function (e) {
            //done.fail(e)
            done();
        };
        req.onsuccess = function () {
    ...
    beforeEach(function (done) {
        db.clear().then(done).catch(done);
    });

    it("getItem() should return undefined if no value was set before", function () {
    ...
    it("basic setItem/getItem", function () {
                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            _context2.prev = 0;
                            _context2.next = 3;
                            return db.setItem("five", 5);

                        case 3:
                            _context2.next = 5;
                            return db.getItem("five");
    ...
    var _loop = function _loop(value, type) {
        it("setItem/getItem should work correctly with data type: " + type, function () {
            var _ref20 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(done) {
                var key, actual;
                    ...
                    switch (_context5.prev = _context5.next) {
                        case 0:
                            ...
                            ps = values.map(function (v) {
                                return db.setItem("order.test", v);
                            });
                            _context5.next = 5;
                        ...
                        case 5:
                            _context5.next = 7;
                            return db.getItem("order.test");

                        case 7:
                            v = _context5.sent;

                            expect(v).toEqual(values[values.length - 1]);
                    ...
                    switch (_context6.prev = _context6.next) {
                        case 0:
                            ...
                            sets = values.map(function (v) {
                                return db.setItem("clear.test." + v, v);
                            });
                            _context6.next = 5;
                        ...
                        case 7:
                            gets = values.map(function (v) {
                                return db.getItem("clear.test." + v);
                            });
                            _context6.next = 10;
    ...
    // assumed db is clear prior to running test
    it("length()", function () {
                ...
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        ...
                        case 3:
                            ...
                            _context7.next = 7;
                            return db.setItem("length.1", "foo");
                        ...
                        case 9:
                            ...
                            _context7.next = 13;
                            return db.setItem("length.2", "foo");
                        ...
                        case 15:
                            ...
                            _context7.next = 19;
                            return db.removeItem("length.2", "foo");
                ...
                while (1) {
                    switch (_context8.prev = _context8.next) {
                        ...
                        case 11:
                            ...
                            _context8.next = 15;
                            return db.setItem("keys.2", "foo");

                        case 15:
                            _context8.next = 17;
                            return db.setItem("keys.3", "foo");
                        ...
                        case 19:
                            ...
                            expect(keys).toEqual(["keys.1", "keys.2", "keys.3"]);
    ...
    it("iterate()", function () {
        var _ref11 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(done) {
            var keyvalues, set, actual;
            return regeneratorRuntime.wrap(function _callee9$(_context9) {
                while (1) {
                    switch (_context9.prev = _context9.next) {
                        case 0:
                            _context9.prev = 0;
                            keyvalues = range(10).map(function (i) {
                                return ["iter." + i, i];
                            });
                            set = keyvalues.map(function (_ref12) {
                        ...
                        case 5:
                            ...
                            db.iterate(function (k, v) {
                                ...
                                expect(actual).toEqual(keyvalues);
                                done();
                            }).catch(done.fail);
                            _context9.next = 12;
                            break;
    ...
    it("iterate()", function () {
        var _ref14 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(done) {
            var keyvalues, set, actual;
                ...
                while (1) {
                    switch (_context10.prev = _context10.next) {
                        case 0:
                            ...
                            set = keyvalues.map(function (_ref15) {
    ...
    it("iterate() with early termination", function () {
        var _ref17 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(done) {
            var keyvalues, set, i, actual;
                ...
                while (1) {
                    switch (_context11.prev = _context11.next) {
                        case 0:
                            _context11.prev = 0;
                            keyvalues = range(10).map(function (i) {
                                return ["iter.early." + i, i];
                            });
                            set = keyvalues.map(function (_ref18) {
                        ...
                        case 5:
                            ...
                            db.iterate(function (k, v) {
                                ...
                                if (i === 5) return 0; // terminate after the 5th iteration
                                i += 1;
                            }).then(function () {
                                expect(actual).toEqual(keyvalues.slice(0, 5));
                                done();
                            }).catch(done.fail);
                            _context11.next = 13;
                            break;
...
},{"../index.js":1,"babel-polyfill":2}]},{},[328]);
